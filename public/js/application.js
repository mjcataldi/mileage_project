...
var placeSearch, autocomplete, origin, destination;
var componentForm = {
...
function initAutocomplete() {
  ...
  origin.addListener('place_changed', fillInAddress(origin));

  destination = new google.maps.places.Autocomplete(
      (document.getElementById('origin')),{types: ['geocode']});
  destination.addListener('place_changed', fillInAddress(destination));
}
...
function geolocate(autocompleteObject) {
